...
import { ApiUrl, ResetPasswordToasterMessage, GeneralError } from '../../../../../assets/constant/constant';
...
export class ResetPasswordComponent implements OnInit, OnDestroy {
    ...
    resetPassword(): void {
        ...
        this._resetPasswordService.resetPassword(this.resetPasswordAPI, formData).then((data: any) => {
            if (data.code === 200) {
                this._toasterService.success(ResetPasswordToasterMessage.successfullyUpdate);
